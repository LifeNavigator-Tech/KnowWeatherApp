            ...
            modelBuilder.Entity("AppUserCity", b =>
                {
                    ...
                    b.ToTable("AppUserCity", (string)null);
                });
            ...
            modelBuilder.Entity("KnowWeatherApp.API.Entities.Weather.WeatherReport", b =>
                {
                    ...
                    b.ToTable("WeatherReports", (string)null);
                });
            ...
            modelBuilder.Entity("KnowWeatherApp.API.Entities.Weather.WeatherReport", b =>
                {
                    ...
                    b.OwnsOne("KnowWeatherApp.API.Entities.Weather.WeatherReport.Current#KnowWeatherApp.API.Entities.Weather.CurrentWeatherReport", "Current", b1 =>
                        {
                            ...
                            b1.ToTable("WeatherReports", (string)null);
                    ...
                    b.OwnsMany("KnowWeatherApp.API.Entities.Weather.WeatherReport.DailyReports#KnowWeatherApp.API.Entities.Weather.DailyWeatherReport", "DailyReports", b1 =>
                        {
                            b1.Property<string>("WeatherReportCityId")
                                .HasColumnType("nvarchar(450)");
                            ...
                            b1.OwnsOne("KnowWeatherApp.API.Entities.Weather.WeatherReport.DailyReports#KnowWeatherApp.API.Entities.Weather.DailyWeatherReport.FeelsLike#KnowWeatherApp.API.Entities.Weather.DailyTempDto", "FeelsLike", b2 =>
                                {
                                    ...
                                    b2.ToTable("WeatherReports", (string)null);

                                    b2.WithOwner()
                                        .HasForeignKey("DailyWeatherReportWeatherReportCityId", "DailyWeatherReportId");
                                });

                            b1.OwnsOne("KnowWeatherApp.API.Entities.Weather.WeatherReport.DailyReports#KnowWeatherApp.API.Entities.Weather.DailyWeatherReport.Temp#KnowWeatherApp.API.Entities.Weather.DailyTempDto", "Temp", b2 =>
                                {
                                    b2.Property<string>("DailyWeatherReportWeatherReportCityId")
                                        .HasColumnType("nvarchar(450)");
                    ...
                    b.OwnsMany("KnowWeatherApp.API.Entities.Weather.WeatherReport.HourlyReports#KnowWeatherApp.API.Entities.Weather.HourlyWeatherReport", "HourlyReports", b1 =>
                        {
                            b1.Property<string>("WeatherReportCityId")
                                .HasColumnType("nvarchar(450)");
